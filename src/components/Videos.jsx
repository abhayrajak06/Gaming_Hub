    ...
    <Stack direction={['column','row']} h={'100vh'} p={'4'}>
        <VStack w={'full'}>
            ...
            <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
              ...
              <Text>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Magnam recusandae aperiam dolorum unde provident expedita ratione qui, nulla corrupti repellat enim voluptates reprehenderit cum hic magni.</Text>
            </VStack>
        </VStack>
